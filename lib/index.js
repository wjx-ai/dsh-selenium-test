        ...
        properties: {
          ...
          actions: {
            ...
            items: {
              type: 'object',
              properties: {
                type: { type: 'string', description: '操作类型：navigate/click/click_js/click_by_text/wait_for_element/click_and_wait/type/screenshot/wait/wait_selector/assert/eval/execute_script/foreach' },
